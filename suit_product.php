...
if ($product_id > 0) {
    $sql = "SELECT description, old_price, new_price, discount_percentage, image_path FROM suit WHERE product_id = $product_id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($is_in_cart) {
        ...
        header("Location: suit_product.php?product_id=$product_id&removed_from_cart=true");
    } else {
        ...
        header("Location: suit_product.php?product_id=$product_id&added_to_cart=true");
    }
    exit();
}
...
<body>
    ...
    <main class="section-main">
        <div class="container">
            <div class="box-1">
                <div class="image">
                    <img src="<?php echo htmlspecialchars($image_path); ?>" alt="Suit Image">
                </div>
                <div class="details">
