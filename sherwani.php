...
// Fetch all sherwani products from the database
$sql = "SELECT * FROM sherwani";
    ...
    <main class="section-main">
        <div class="container">
            <div class="address">
                ...
                <p class="path">/ Sherwani</p>
            </div>
            <div class="section-browse">
                <?php
                // Loop through each sherwani product and display it
                while ($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="product">';
                    echo '<a href="sherwani_product.php?product_id=' . $row['product_id'] . '">';
                    echo '<img src="' . $row['image_path'] . '" alt="Sherwani Image">';
