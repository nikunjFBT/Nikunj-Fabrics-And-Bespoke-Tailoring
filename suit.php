...
// Fetch all suit products from the database
    ...
    <main class="section-main">
        <div class="container">
            ...
            <div class="section-browse">
                <?php
                // Loop through each suit product and display it
                while ($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="product">';
                    echo '<a href="suit_product.php?product_id=' . $row['product_id'] . '">';
                    echo '<img src="' . $row['image_path'] . '" alt="Suit Image">';
